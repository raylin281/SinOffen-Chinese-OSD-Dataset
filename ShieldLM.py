...
# 加载 tokenizer 和模型
tokenizer = AutoTokenizer.from_pretrained("thu-coai/ShieldLM-13B-baichuan2", trust_remote_code=True)

# 检查并设置 pad_token
if tokenizer.pad_token is None:
    tokenizer.pad_token = tokenizer.eos_token

model = AutoModelForCausalLM.from_pretrained("thu-coai/ShieldLM-13B-baichuan2", device_map="auto", trust_remote_code=True).eval()
